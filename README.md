...
- HTML
  - No errors were returned when passing through the official W3C validator, all HTML code from script.js functions have also been validated through this service - https://validator.w3.org/
- CSS
